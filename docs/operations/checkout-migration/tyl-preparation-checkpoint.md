> Historical checkpoint. Superseded by the user’s 9 September 2026 decision to use Stripe. Do not continue Tyl onboarding or activate these clients. See [current handoff](README.md).
