...
| `/apply[.html]` | Existing new installation form, connected to verified durable intake and Stripe Checkout | Keep 19 fields, consents, prefill/cancellation context, server-controlled price and stable application/payment reference. |
| `/success[.html]`, Stripe and legacy Tyl/browser return URLs | New truthful status page backed by authoritative state | Preserve relevant references safely. No “paid/received” state from a query string or unbound signature alone. |
| `/terms[.html]`, `/privacy[.html]`, `/refunds[.html]` | Complete new styled policies | Payment-provider wording follows the verified Stripe implementation; preserve substantive service/refund/consent terms. |
