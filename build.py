...
PAGES = {
    ...
    "faq": ("Application questions", "Find the application questions and answers on the Aesir Solar homepage.", "bridge"),
}
...
def render(slug):
    ...
    values = {
        ...
        "CANONICAL": "https://aesirsolar.co.uk/#application-faqs" if slug == "faq" else f"https://aesirsolar.co.uk/{slug}.html",
        "PAGE": slug, "KIND": kind, "BODY": body,
        "HEAD_EXTRA": '<meta http-equiv="refresh" content="0;url=/#application-faqs">' if slug == "faq" else '',
