...
TERMS = f'''    <p class="eyebrow">Legal</p>
    ...
    <div class="prose">
      <div class="callout">
        ...
        application to your network operator, and to deal with them until they reach a decision.
        That fee covers the application only. We can't make the network operator say yes.</p>
      </div>
