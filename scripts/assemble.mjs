...
const siteCode=sizes.find(x=>/^site-.*\.js$/.test(x.file));
const incremental={regionRawBytes:region?.bytes??0,regionGzipBytes:region?.gzip??0,regionCodeGzipBytes:regionCode?.gzip??0,siteCodeGzipBytes:siteCode?.gzip??0,budgets:{regionRaw:550000,regionGzip:180000,regionCodeGzip:10000,siteCodeGzip:20000}};
const pass=totalJS<=750000&&mediaBytes<=2000000&&incremental.regionRawBytes<=550000&&incremental.regionGzipBytes<=180000&&incremental.regionCodeGzipBytes<=10000&&incremental.siteCodeGzipBytes<=20000;
